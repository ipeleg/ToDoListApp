		...
		edit.setOnClickListener(new View.OnClickListener()
		{
			public void onClick(View v)
			{
				if (!isEditing) // If the user wants to edit change the background and let the user edit fields
				{
					...
					activityLayout.setBackgroundResource(R.drawable.carbon_2);
				}
				else // Else revert the background to normal color, close the edit mode and update task in database
				{
					if (checked)
					{
						if (!isDateAndTimeSet())
